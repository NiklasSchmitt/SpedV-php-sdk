<?php
/**
 * FPHSpedVAPIObjectsSpeditionsTruckType
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * FPHSpedVAPIObjectsSpeditionsTruckType Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FPHSpedVAPIObjectsSpeditionsTruckType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FPH.SpedV.API.Objects.Speditions.TruckType';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('manufactor', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['manufactor'] === null) {
            $invalidProperties[] = "'manufactor' can't be null";
        }
        ...
        if ($this->container['rent_price'] === null) {
            $invalidProperties[] = "'rent_price' can't be null";
        }
    ...
    {
        return $this->container['manufactor'];
    }

    /**
     * Sets manufactor
     *
     * @param string $manufactor manufactor
     *
     * @return self
     */
    public function setManufactor($manufactor)
    {
        if (is_null($manufactor)) {
            array_push($this->openAPINullablesSetToNull, 'manufactor');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('manufactor', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['manufactor'] = $manufactor;
     ...
     * Sets rent_price
     *
     * @param int $rent_price rent_price
     *
     * @return self
     */
