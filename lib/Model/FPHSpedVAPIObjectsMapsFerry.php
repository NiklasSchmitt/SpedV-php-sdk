...
/**
 * FPHSpedVAPIObjectsMapsFerry Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FPHSpedVAPIObjectsMapsFerry implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FPH.SpedV.API.Objects.Maps.Ferry';
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'start' => '\OpenAPI\Client\Model\FPHSpedVAPIObjectsMapsHarbor',
        'destination' => '\OpenAPI\Client\Model\FPHSpedVAPIObjectsMapsHarbor',
        'amount' => 'int',
        'company' => 'string',
        'currency' => 'string',
        'distance' => 'int'
    ...
    */
     ...
     * Gets start
     *
     * @return \OpenAPI\Client\Model\FPHSpedVAPIObjectsMapsHarbor
     */
     ...
     * Sets start
     *
     * @param \OpenAPI\Client\Model\FPHSpedVAPIObjectsMapsHarbor $start start
     *
     * @return self
     */
     ...
     * Sets destination
     *
     * @param \OpenAPI\Client\Model\FPHSpedVAPIObjectsMapsHarbor $destination destination
     *
     * @return self
     */
