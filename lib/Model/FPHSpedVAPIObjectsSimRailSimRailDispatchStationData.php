...
/**
 * FPHSpedVAPIObjectsSimRailSimRailDispatchStationData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FPHSpedVAPIObjectsSimRailSimRailDispatchStationData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FPH.SpedV.API.Objects.SimRail.SimRailDispatchStationData';
    ...
    protected static $openAPITypes = [
        ...
        'server' => '\OpenAPI\Client\Model\FPHSpedVAPIObjectsSimRailSimRailServerInfo',
        'steam_id' => 'int'
    ];
    ...
    */
     ...
     * Sets server
     *
     * @param \OpenAPI\Client\Model\FPHSpedVAPIObjectsSimRailSimRailServerInfo $server server
     *
     * @return self
     */
    ...
    {
        if (is_null($steam_id)) {
            array_push($this->openAPINullablesSetToNull, 'steam_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('steam_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
