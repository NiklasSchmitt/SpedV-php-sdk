<?php
/**
 * FPHSpedVAPIObjectsSimRailSimRailServerInfo
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * FPHSpedVAPIObjectsSimRailSimRailServerInfo Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FPHSpedVAPIObjectsSimRailSimRailServerInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FPH.SpedV.API.Objects.SimRail.SimRailServerInfo';
    ...
    {
        $this->setIfExists('server_code', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['server_region'] === null) {
            $invalidProperties[] = "'server_region' can't be null";
        }
     ...
     * Sets server_code
     *
     * @param string $server_code server_code
     *
     * @return self
     */
    public function setServerCode($server_code)
    {
        if (is_null($server_code)) {
            array_push($this->openAPINullablesSetToNull, 'server_code');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('server_code', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets server_region
     *
     * @param string $server_region server_region
     *
     * @return self
     */
