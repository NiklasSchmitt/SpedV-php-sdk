...
/**
 * FPHSpedVAPIObjectsSpeditionsVacation Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FPHSpedVAPIObjectsSpeditionsVacation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FPH.SpedV.API.Objects.Speditions.Vacation';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ende'] === null) {
            $invalidProperties[] = "'ende' can't be null";
        }
